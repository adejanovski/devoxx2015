...
@WebServlet(asyncSupported = false, value = "/get-top-societe", loadOnStartup = 1)
public class CountTopSocieteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse response)
		...
		mapper.writeValue(out, CassandraAccess.INSTANCE.getTopSociete());
