...
@WebServlet(asyncSupported = false, value = "/get-top-speakers", loadOnStartup = 1)
public class CountTopSpeakersServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse response)
		...
		mapper.writeValue(out, CassandraAccess.INSTANCE.getTopSpeaker());
