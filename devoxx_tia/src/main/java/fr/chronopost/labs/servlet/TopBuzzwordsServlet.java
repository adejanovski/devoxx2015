...
@WebServlet(asyncSupported = false, value = "/get-top-buzzwords", loadOnStartup = 1)
public class TopBuzzwordsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse response)
		...
		mapper.writeValue(out, CassandraAccess.INSTANCE.getTopBuzzwords());
