...
@WebServlet(asyncSupported = false, value = "/get-type-by-annee", loadOnStartup = 1)
public class TypeTalkParAnneeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse response)
		...
		out.print(Utils.formatGraphData(CassandraAccess.INSTANCE.getByTalksTypeParAnnee()));
