...
@WebServlet(asyncSupported = false, value = "/get-count-by-type", loadOnStartup = 1)
public class CountByTypeTalkServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse response)
		...
		mapper.writeValue(out, CassandraAccess.INSTANCE.getByTalksType());
