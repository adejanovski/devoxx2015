...
@WebServlet(asyncSupported = false, value = "/get-count-talks", loadOnStartup = 1)
public class CountTalksServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse response)
		...
		out.print(CassandraAccess.INSTANCE.getNbTalks());
