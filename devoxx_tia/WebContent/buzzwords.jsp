 ...
 <header class="header black-bg">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">                            	  
                  ...
                  <li class="sub-menu">
                      <a class="active" href="buzzwords.html" >
      			...
      			<div class="col-lg-12 main-chart">
					...
					<div class="row">
                      ...
                      <div class="border-head">
                          <h1><%out.print(request.getParameter("buzzword")); %></h1>
                      </div>
                      <div class="col-lg-12">
                          <div class="content-panel">							  
                              <div class="panel-body text-center" id="graph-container">
                                  <div id="buzzword-chart"  class="graph"></div>
                              </div>
                          </div>
                      </div>
                      <!--custom chart end-->
	...
	<script type="text/javascript">
        $(document).ready(function () {        	
        	drawBuzzwordChart('<%out.print(request.getParameter("buzzword")); %>');
