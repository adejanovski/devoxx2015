  ...
  <section id="container" >
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">                            	  
                  ...
                  <li class="sub-menu">
                      <a class="active" href="speakers.html" >
			...
			<div class="col-lg-12 main-chart">                     
					...
					<div class="row">
                      ...
                      <div class="border-head">
                          <h1><%out.print(request.getParameter("nom_speaker")); %></h1>
                      </div>
                      <div class="col-lg-12">
                          <div class="content-panel">							  
                              <div class="panel-body text-center" id="graph-container">
                                  <div id="speaker-chart"  class="graph"></div>
                              </div>
                          </div>
                      </div>
                      <!--custom chart end-->
	...
	<script type="text/javascript">
        $(document).ready(function () {
        	getSpeakerTalks('<%out.print(request.getParameter("id_speaker")); %>');
        	drawSpeakerChart('<%out.print(request.getParameter("nom_speaker")); %>');
